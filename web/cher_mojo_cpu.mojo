...
from european_call_cpu import Network, Params


@export
fn PyInit_cher_mojo_cpu() -> PythonObject:
    try:
        m = PythonModuleBuilder('cher_mojo_cpu')
        ...
        abort(String('error creating cher_mojo_cpu', e))
